<!--   eComm PRO - Search Template (Stylish - Plain)
  ==========================================================================-->
<!--Version 2.01.002 -->
<HTML>
<HEAD>
...
<!--   Page Title
  ==========================================================================-->
  <TITLE>Bienvenido a la tienda Paleta</TITLE>


<!--   Meta Tags used by Search Engines
  ==========================================================================-->
  <META NAME="description" content="Bienvenido a la tienda Paleta">
  <META NAME="keywords" CONTENT="">
  <META NAME="generator" content="eComm PRO v2.08">
  <META NAME="resource-type" content="document">
  <META NAME="distribution" content="Global">
  <META NAME="robots" content="All">
  <META NAME="copyright" content="Copyright ©2001 Pinturas Paleta">


<!--   Page Style.  This changes color of links to red on mouse over
  ==========================================================================-->
  <style type="text/css">A:hover{color:#F0A000;}
...
<!--   Page definitions, variables are replaced by Scheme colors
  ==========================================================================-->
  <BODY TEXT=BLACK BGCOLOR=WHITE LINK=#060100 VLINK=#05014B ALINK=#F0A000 topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
...
<a href="36.htm"><img src="r1_home.png" BORDER=0 align=texttop></a>&nbsp;</td>
...
<!--   Create the Product Navigation Index here
  ==========================================================================-->
  <table width=100%><tr><td valign=top width=5%><img src="o_2.png"></td><td class=b><a href="36.htm">Inicio</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="25.htm">Nuestros Servicios</a></td></tr>
<tr><td valign=top width=5%><img src="f_2.png"></td><td class=m><a href="index.html">Productos</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="news.html">Noticias</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="about.html">Quienes Somos</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="contact.html">Contacto</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="22.htm">Ubicacion</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="23.htm">Preguntas Frecuentes</a></td></tr>
<tr><td valign=top width=5%><img src="g_2.png"></td><td class=m><a href="24.htm">Invierta con Nosotros</a></td></tr>
<tr><td valign=top width=5%><img src="f_2.png"></td><td class=m><a href="34.htm">Siguenos</a></td></tr>
...
<!--   Insert Back Button
  ==========================================================================-->
  <a HREF="36.htm"><img src="r1_back.png" border=0 alt="Back" align=TEXTTOP></a></td>

<!-- Uncomment to add Purchase/back/Remove buttons to category
<a HREF="36.htm"><img src="r1_back.png" border=0 alt="Back" align=TEXTTOP></a></td>
<td ALIGN=left VALIGN=TOP BACKGROUND="r1_topbac.png" width=100%>
 <A HREF="javascript:addItem('36.htm','','Inicio','0.00','img/r1_home.png',1,0,0,0,'','')"><img src="r1_add.png" border=0></a><a HREF="javascript:removeItem('')"><img src="r1_remove.png" border=0></a></td>
-->
...
<br>
<!-- Product name start -->
<b><font face="Verdana, Arial" color="#666666" size=+2>Bienvenido a la tienda Paleta</font></b>
<br><br>

<!-- IMAGE starts -->
<img src="img/r1_home.png" ALT="Inicio" BORDER=0></a><br>
